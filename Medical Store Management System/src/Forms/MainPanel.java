...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        medicineBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        companiesBtn.setBackground(new java.awt.Color(255, 51, 51));
        ...
        viewSalesRecordsBtn.setBackground(new java.awt.Color(255, 0, 0));
        ...
        newSalesBtn.setBackground(new java.awt.Color(255, 0, 0));
        ...
        changePasswordBtn.setBackground(new java.awt.Color(255, 0, 0));
        ...
        createUserBtn.setBackground(new java.awt.Color(255, 0, 0));
        ...
        addNewProductCategoryBtn.setBackground(new java.awt.Color(255, 51, 0));
        ...
        jLabel5.setText("Rural Medical Store Management System");
    ...
    private void searchTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTxtKeyReleased
              try{
          String sql = "SELECT  * FROM products WHERE product_name LIKE '%"+ searchTxt.getText() +"%'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            medicineTable.setModel(DbUtils.resultSetToTableModel(rs));
        }catch(Exception e){
